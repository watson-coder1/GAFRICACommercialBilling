...
$_app_stage = 'Dev'; # Development mode for local testing
...
$db_pass    = "SecureP@ssw0rd123!"; # Database Password
$db_name    = "nuxbill_local"; # Database Name (separate for local testing)
