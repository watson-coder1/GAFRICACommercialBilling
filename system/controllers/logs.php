...
switch ($action) {
    ...
    case 'message':
        ...
        if ($q !== null && $q !== '') {
            ...
            ->whereRaw("message_type LIKE ? OR recipient LIKE ? OR message_content LIKE ? OR status LIKE ? OR error_message LIKE ?", [$searchTerm, $searchTerm, $searchTerm, $searchTerm, $searchTerm])
